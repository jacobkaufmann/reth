    ...
    >,
{
    ...
    fn validate_block_inclusion_list(
        ...
        let block_available_gas = header.gas_limit() - exec_output.gas_used;
        ...
        for tx in il.as_ref() {
            ...
            if evm.transact(tx_env).is_ok() {
                return Err(BlockExecutionError::Validation(BlockValidationError::InclusionList));
            }
        }
