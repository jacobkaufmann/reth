...
pub use reth_execution_types::{BlockExecutionInput, BlockExecutionOutput, BlockExecutionResult, ExecutionOutcome};
...
pub trait Executor<DB: Database>: Sized {
    ...
    where
        I: IntoIterator<Item = BlockExecutionInput<'a, RecoveredBlock<<Self::Primitives as NodePrimitives>::Block>>>,
    {
...
pub trait BlockExecutionStrategy {
    ...
    fn apply_post_execution_changes<'a>(
        &mut self,
        block: &RecoveredBlock<<Self::Primitives as NodePrimitives>::Block>,
    ...
    DB: Database,
{
    ...
    {
        let BlockExecutionInput { block, il } = block;
